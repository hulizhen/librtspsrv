...
#define RTSP_SERVER     "Zmodo-RTSP-Server"
 ...
 */
#define TIMER_SD_DFL_EV     (EPOLLIN | EPOLLET)
#define RTSP_LSN_SD_DFL_EV  (EPOLLIN | EPOLLET)
#define RTSP_SD_DFL_EV      (EPOLLIN | EPOLLET)
#define RTP_SD_DFL_EV       (EPOLLET)
#define RTCP_SD_DFL_EV      (EPOLLIN | EPOLLET)
 ...
 */
struct rtsp_srv {
    pthread_t rtsp_srv_tid;     /* Thread ID of RTSP server thread. */
    int epoll_fd;               /* File descriptor for epoll events. */
