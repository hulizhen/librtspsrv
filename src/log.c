...
#if LOG_SWITCH
    log_msg("hello world\n");
    printd("Test for log color ^_^\n");
    printd(EMERG"Test for log color ^_^\n");
    printd(ALERT"Test for log color ^_^\n");
    printd(CRIT"Test for log color ^_^\n");
    printd(ERR"Test for log color ^_^\n");
    printd(WARNING"Test for log color ^_^\n");
    printd(NOTICE"Test for log color ^_^\n");
    printd(INFO"Test for log color ^_^\n");
    printd(DEBUG"Test for log color ^_^\n");
    usleep(1);
    exit(1);
#endif
    return;
